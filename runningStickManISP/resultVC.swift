...
class resultVC: UIViewController {
    ...
    var showMark=false
    //use bool to find if calculate mark or not
    ...
    override func viewDidLoad() {
        ...
        if showMark{
            // if it comes after playing
            if newName == ""{
                newName="anonymous"
            }//don't let the name empty
        var counter=2
            //a counter for representing index
        for _ in 0...2{
            if scoreArray[counter]<=newMark && newMark != 0{
            ...
            if rank<=3{
                ...
                feedBack.text="Try better next time."
            }//proper feed back if not in rank
        ...
        //prevent marks be 0 at beginning
    }
